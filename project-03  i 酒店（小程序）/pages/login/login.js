...
Page({
  ...
  bind_phone(e) {
    that.setData({
      pwd_visiable: !that.data.pwd_visiable
    })
  },

  bind_wx() {
    that.setData({
      wx_visiable: !that.data.wx_visiable,
      pwd_visiable: false
    })
  },
  ...
  bind_check_login() {
    that.setData({
      more_hotel_visiable: !that.data.more_hotel_visiable,
      pwd_visiable: false,
      wx_visiable: false,
    })
  },
